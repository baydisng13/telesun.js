...
የቴሌግራም ቦት የቴሌግራም ተጠቃሚዎች በቻቶቻቸው፣ በቻናሎቻቸው ወይም በቡድኖቻቸው ውስጥ ሊዋሃዱ የሚችሉ ተግባራትን እና አውቶማቲክን የሚሰጥ ፕሮግራም ነው።

ቴሌሱን ጃቫ ስክሪፕት እና አፕስ ስክሪፕት በመጠቀም የራስዎን የቴሌግራም ቦቶች ማዳበር ቀላል የሚያደርግልዎ ላይብረሪ ነው።

### ዋና መለያ ጸባያት

- ሙሉ ቴሌግራም Bot API 6.0 ድጋፍ
- ቀላል 🌟
- እንደ `Youtube`፣ `Drive`፣ `Gmail`... ባሉ የGoogle ምርቶች ላይ መስራት ቀላል ነው።
- በአንድ ጠቅታ በ Google ደመና ላይ ማሰማራት
- ሪል-ታይም ዳታቤዝ (Google Sheet) አስቀድሞ ተዋህዷል
- የእርስዎን Bots 100+ ይገንቡ
- መሰረታዊ ጃቫስክሪፕት በቂ ነው።

---

## [እንዴት Apps Script እንጀምርራለን](https://github.com/abdiu34567/telesun.js/wiki/Getting-Started)
...
ላይብረሪውን አንዴ ካስገቡ በኋላ የሚከተለውን `function` መፍጠር ይችላሉ እና ማንኛውንም መልእክት ወደ ቦትዎ ይላኩ እና ወደ ቴሌሱን እንኳን ደህና መጡ የሚለውን ተግባር ያሂዱ ።
